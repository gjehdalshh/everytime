...
<div class="div3">
	...
	<c:forEach var="hotList" items="${hotList}" end="2">
		<div onclick="hotBoardMove(${hotList.i_board}, ${hotList.i_user}, ${hotList.i_board_type})" class="div_1">
			<div class="flex_div">
				<div class="flex">
